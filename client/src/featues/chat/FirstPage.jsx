...
function FirstPage() {
  return (
    <div className="text-neutral-600 text-xl font-semibold w-full h-full dark:bg-neutral-950/50 bg-neutral-200 flex items-center justify-center flex-col gap-5">
