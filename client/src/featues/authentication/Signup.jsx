...
function Signup() {
  ...
  return (
    <div className="rounded px-5 py-2 shadow-2xl border border-zinc-300 w-[600px] bg-neutral-100 dark:bg-neutral-800/70 dark:border-none dark:text-neutral-400">
