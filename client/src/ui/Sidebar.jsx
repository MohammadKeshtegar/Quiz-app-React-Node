...
function Sidebar() {
  ...
  return (
    <div className="w-64 min-h-[calc(100vh-64px)] px-2 flex flex-col border-r-2 border-blue-500 dark:text-neutral-300 text-black dark:bg-gradient-to-tl from-neutral-900 to-neutral-800">
      {user.email ? (
        user?.role === "user" ? (
