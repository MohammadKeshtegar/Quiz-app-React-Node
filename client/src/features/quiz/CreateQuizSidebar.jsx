...
function CreateQuizSidebar({ setEditQuestion, setQuestionIndex, questions, quizTime, category, questionIndex }) {
  ...
  return (
    <div className="w-[266px] min-h-full p-2 border-l border-blue-400 dark:text-white text-black flex flex-col gap-2">
      <p>
      ...
      <div className="mt-auto mb-1">
        <ButtonLink
          styleType="fill"
          customeStyle="w-full justify-center text-white"
          disable={linkDisable}
