...
function CreateQuestion({ questions, setQuizTime, setCategory, editQuestion, setEditQuestion, setQuestionIndex, editQuiz }) {
  ...
  return (
    <div className="w-full p-5 dark:text-white text-black">
      <Form
        onSubmit={handleSubmit(onSubmit)}
        className="flex flex-col gap-3 border border-neutral-100 dark:border-none p-3 rounded dark:bg-neutral-800 shadow-custom-2"
      >
        ...
        <div className="p-5 dark:bg-neutral-900 rounded border dark:border-neutral-700">
          <textarea
            placeholder="Question..."
            className="dark:bg-neutral-700 bg-neutral-100 border rounded w-full focus:outline-none px-4 py-2 dark:border-none dark:text-neutral-300 dark:placeholder:text-neutral-500 focus:ring-1 focus:ring-blue-500 mt-5"
            rows={3}
            name="question"
