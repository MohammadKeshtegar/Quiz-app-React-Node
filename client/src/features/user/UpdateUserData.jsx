        ...
        <div className="flex flex-col gap-2 w-5/6 ml-12">
          <FormRow htmlFor="photo" text="User photo">
            <input
              ...
              accept="image/*"
              id="photo"
              className="dark:bg-neutral-600 bg-neutral-100 input-file rounded cursor-pointer dark:text-neutral-400 focus:ring-[2px] focus:ring-blue-600 focus:border-none focus:outline-none w-full"
              {...register("photo")}
