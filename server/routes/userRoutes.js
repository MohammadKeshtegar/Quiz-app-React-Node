...
import { deleteUser, getAllUsers, getNotTeammateUsers, getUser, updateUser, uploadUserPhoto, userQuizResult } from "../controller/userController.js";
...
router.route("/not-teammate-users/:id").get(protect, getNotTeammateUsers);
